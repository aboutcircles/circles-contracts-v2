...
contract DiscountedBalances is Demurrage {
    ...
    // uint8 private constant R_TABLE_LOOKUP = uint8(14);

    // State variables

    // uint256 public immutable inflation_day_zero;
    ...
    //      */
    //     function _calculateDiscountedBalance(uint256 _balance, uint256 _daysDifference) private view returns (uint256) {
